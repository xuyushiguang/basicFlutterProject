...
class R {
  /// package name: base_flutter_app
  static const package = "base_flutter_app";
...
class _R_Image_AssetResource {
  ...
  /// asset: lib/assets/images/test1.png
  // ignore: non_constant_identifier_names
  final test1 =
      const AssetResource("assets/images/test1.png", packageName: R.package);
}
...
class _R_Image {
  ...
  // ignore: non_constant_identifier_names
  AssetImage test1() {
    return AssetImage(asset.test1.keyName);
  }
}
